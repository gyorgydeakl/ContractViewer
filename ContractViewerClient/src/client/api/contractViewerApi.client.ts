...
export class ContractViewerApiClient extends BaseService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public generateDocuments(generateDocumentRequest: GenerateDocumentRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain', context?: HttpContext, transferCache?: boolean}): Observable<string>;
    public generateDocuments(generateDocumentRequest: GenerateDocumentRequest, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<string>>;
    public generateDocuments(generateDocumentRequest: GenerateDocumentRequest, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<string>>;
    public generateDocuments(generateDocumentRequest: GenerateDocumentRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain', context?: HttpContext, transferCache?: boolean}): Observable<any> {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public generateRandomContracts(generateContractRequest: GenerateContractRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<Array<ContractSummary>>;
    public generateRandomContracts(generateContractRequest: GenerateContractRequest, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<Array<ContractSummary>>>;
    public generateRandomContracts(generateContractRequest: GenerateContractRequest, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<Array<ContractSummary>>>;
    public generateRandomContracts(generateContractRequest: GenerateContractRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (generateContractRequest === null || generateContractRequest === undefined) {
            throw new Error('Required parameter generateContractRequest was null or undefined when calling generateRandomContracts.');
        }
        ...
        let localVarPath = `/contracts/random`;
        const { basePath, withCredentials } = this.configuration;
