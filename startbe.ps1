...
$procs += Start-Process dotnet -ArgumentList 'run --project ".\ContractViewerApi\OtherServiceApi\OtherServiceApi.csproj" --no-build' -PassThru
$procs += Start-Process dotnet -ArgumentList 'run --project ".\ContractViewerApi\CacheAdminApi\CacheAdminApi.csproj" --no-build' -PassThru
